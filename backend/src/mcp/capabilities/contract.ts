...
const baseCapabilitiesContract = [
  ...
  },
  {
    ...
    requiredQuery: ["organizationID"],
    optionalQuery: ["vesselID", "scheduleID", "activityID", "activityWorkHistoryID", "tagName", "tagNames", "taggedOnly", "majorJobsOnly", "maintenanceType", "performedBy", "attachmentsOnly", "partsUsedOnly", "riskAssessmentOnly", "startDate", "endDate", "limit"],
  ...
  },
  {
    ...
    requiredQuery: ["organizationID"],
    optionalQuery: ["vesselID", "status", "urgency", "days", "startDate", "endDate", "searchTerm", "leadTimeExceptionOnly", "fulfillmentFilter", "fulfillmentPercent", "fulfillmentPercentOperator", "limit"],
  ...
  },
  {
    ...
    requiredQuery: ["organizationID"],
    optionalQuery: ["vesselID", "status", "criticalOnly", "openGapOnly", "documentsOnly", "partSearchTerm", "limit"],
